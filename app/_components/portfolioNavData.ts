...
/** Gốc chân cột (world). Tránh sát (0,0): giữa đảo là núi đá trong GLB; preset `menu.position` giữ cố định. */
export const SIGNPOST_ANCHOR: [number, number, number] = [-5.2, 2.0, -5.4];
...
export function getCameraPresets(orbitY: number): Record<NavId | "menu", CameraPreset> {
